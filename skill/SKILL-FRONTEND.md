...
description: >
  ...
  ecosystem topics, install the full `sei` skill or the dedicated
  `sei-contracts` / `sei-ecosystem` variants.
user-invocable: true
license: MIT
...
- Multi-chain dApp: Wagmi with `chains: [sei, seiTestnet, mainnet, ...]`
...
- Common errors: [contracts/common-errors.md](references/contracts/common-errors.md)
